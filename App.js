...
import RestaurantManagementComponent from "./RestaurantManagementComponent/RestaurantManagementComponent";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/restaurant/delivery/register"
        ...
        <Route path="/food/:foodId/category/:categoryId" element={<Food />} />
        <Route path="/food/:foodId/review/add" element={<AddFoodReview />} />
        ...
        />
        <Route
          path="/restaurant/order/all"
          element={<ViewRestaurantOrders />}
        />
        ...
        <Route
          ...
          element={<RestaurantManagementComponent />}
        />
      </Routes>
    </div>
  );
